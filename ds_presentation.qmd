...
-   Applicants = primarily **low-income parents**
-   Algorithm disproportionately flagged:
    -   People with immigrant backgrounds\
    -   Dual citizens\
    -   Women\
-   These groups were **not** representative of fraud risk\
-   Result: systemic discrimination + severe social and financial harm

---

## Who was measured?

-   Program targeted **low-income parents and caregivers**
-   These applicants were representative of the program’s population\
-   But algorithmic predictions **did not generalize** to fraud risk\
-   Result: unfair targeting of the very group the system was meant to help

---

[![](media_pics/dutch_scandal.png){fig-align="center" width="433"}](https://equineteurope.org/netherlands-institute-for-human-rights-role-in-the-investigation-of-the-childcare-allowance-scandal/)

![Image source: Equinet Europe (Netherlands Institute for Human Rights) https://equineteurope.org/netherlands-institute-for-human-rights-role-in-the-investigation-of-the-childcare-allowance-scandal/](media_pics/dutch_scandal_2.png){fig-align="center" width="500"}
...
-   Data originally collected to **support families**
-   Reframed as part of “tough on fraud” policy\
-   Algorithm punished marginalized families instead of protecting them\
-   Sparked public outrage + parliamentary investigation\
-   **Helped trigger collapse of Dutch government (2021)**
